  ...
  return (req, res, next) => {
    ...
    const permisos = {
      admin: {
        ...
        notaMedica: ['create', 'read', 'update', 'delete'],
        capacitacion: ['create', 'read', 'update', 'delete'],
        sancion: ['create', 'read', 'update', 'delete'],
        ascenso: ['create', 'read', 'update', 'delete'],
        auditoria: ['read'],
        reporte: ['read', 'create'],
      },
      supervisor: {
        ...
        notaMedica: ['create', 'read', 'update'],
        capacitacion: ['create', 'read', 'update'],
        sancion: ['create', 'read', 'update'],
        ascenso: ['create', 'read', 'update'],
        auditoria: ['read'],
        reporte: ['read', 'create'],
      },
      usuario: {
